...
//	Distance_Symbols = (distance > 0.0 ? 1 : -1);
  ...
  printf("input_distance_abs = %f , slowly_distance_temp = %f , distance_acc_dec_temp = %f ", input_distance_abs, slowly_distance_temp, distance_acc_dec_temp);
  ...
  // else if (( input_distance_abs +  slowly_distance_temp) > distance_acc_dec_temp )     //存在匀速段
    {
    	...
    	//匀速时间
    	const_time = (( input_distance_abs +  slowly_distance_temp) - distance_acc_dec_temp) / Interpolation_Parameter.max_velocity_abs;    //匀速时间
...
int Interpolation_Cal_Velocity(float current_distance, struct Interpolation_Parameter_t Interpolation_Parameter)
{
	...
	printf(" 123456current_distance = %f , acc_distance = %f , const_distance = %f , Interpolation_Parameter.accleration_abs = %f\n " , current_distance , acc_distance , const_distance , Interpolation_Parameter.accleration_abs);
	//获取插补速度
