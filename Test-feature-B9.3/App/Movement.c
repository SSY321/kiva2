...
int Movement_Cal_Velocity(Coordinate_Class_t Current_Coor_InWorld, struct Interpolation_Parameter_t Interpolation_Parameter)
{
	...
	printf("123Current_Coor_InOrigin.x_coor = %f \n", Current_Coor_InOrigin.x_coor);
	printf("123Current_Coor_InOrigin.y_coor = %f \n", Current_Coor_InOrigin.y_coor);
	printf("123Current_Coor_InOrigin.angle_coor = %f \n", Current_Coor_InOrigin.angle_coor);
	printf("123Current_Coor_InOrigin.angle_rad = %f \n", Current_Coor_InOrigin.angle_rad);
