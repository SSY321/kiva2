...
Coordinate_Class_t Odom_Calib(float velocity_x, float angular_velocity_angle)
{
	float temp_y, temp_x;
    //struct Coordinate_Class Coor_delta;
    velocity_x = fabs(velocity_x);  //保证AGV的速度为正值
	...
	printf("22222222Coor_delta.x_coor = %f, Coor_delta.y_coor = %f, Coor_delta.angle_coor = %f\n", Coor_delta.x_coor, Coor_delta.y_coor, Coor_delta.angle_coor);
